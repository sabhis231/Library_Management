...
$(function () {
    ...
    $("body").on("click", ".book-operation", function () {
        ...
        $("#description").html(selectedBook[0].description);
    });
...
var renderData = function (bookArray) {
    ...
    if (bookArray.length == 0) {
        ...
        for (var a of bookArray) {
            ...
            data += '  <a class="btn btn-primary book-operation" data-toggle="modal" data-target="#exampleModal" data-bookId="' + a.bookId + '">Borrow book</a>'
            data += '</td>'
            data += "</tr>"
        }
    }
